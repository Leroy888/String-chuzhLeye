...
public:
    ...
    void setupUi(QWidget *SeeWidget)
    {
        ...
        SeeWidget->resize(1119, 701);
        SeeWidget->setMaximumSize(QSize(16777215, 16777215));
        ...
        widget_5->setMinimumSize(QSize(50, 50));
        widget_5->setMaximumSize(QSize(50, 80));
        ...
        ruler_w->setMinimumSize(QSize(0, 50));
        ruler_w->setMaximumSize(QSize(16777215, 50));
        ...
        ruler_h->setMaximumSize(QSize(50, 16777215));
