...
public:
    ...
    void setupUi(QMainWindow *NXMainWindow)
    {
        ...
        NXMainWindow->setMaximumSize(QSize(16777215, 16777215));
        NXMainWindow->setContextMenuPolicy(Qt::ActionsContextMenu);
        NXMainWindow->setStyleSheet(QLatin1String("background-color: rgb(54, 54, 54);\n"
